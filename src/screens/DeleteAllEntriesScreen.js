...
export default function DeleteAllEntriesScreen({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Delete All Entries</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.text}>Delete All Entries for {bookName}</Text>
      </View>
    </SafeAreaView>
  );
}
